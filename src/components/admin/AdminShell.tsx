...
/**
 * Two-column shell for authenticated admin routes. Sidebar = navigation +
 * sign-out; main column = the page content.
 */
export function AdminShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-[240px_1fr] bg-void-0 text-text-primary">
      <aside className="border-b md:border-b-0 md:border-r border-void-3 bg-void-1/40 p-6 md:sticky md:top-0 md:h-screen flex md:flex-col gap-6 md:gap-10 items-center md:items-stretch justify-between md:justify-start">
        <div>
            ...
            return (
              <Link
                ...
                className={[
                  ...
                  active
                    ? 'bg-void-3/60 text-text-bright border-l-2 border-gold-core'
